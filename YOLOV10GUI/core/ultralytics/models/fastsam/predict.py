...
from YOLOV10GUI.core.ultralytics.models.fastsam.utils import bbox_iou
...
class FastSAMPredictor(DetectionPredictor):
    """
    FastSAMPredictor is specialized for fast SAM (Segment Anything Model) segmentation prediction tasks in YOLOV10GUI.core.ultralytics
    YOLO framework.
