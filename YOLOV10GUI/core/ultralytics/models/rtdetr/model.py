...
from YOLOV10GUI.core.ultralytics.nn.tasks import RTDETRDetectionModel
...
class RTDETR(Model):
    ...
    def task_map(self) -> dict:
        """
        Returns a task map for RT-DETR, associating tasks with corresponding YOLOV10GUI.core.ultralytics classes.

        Returns:
            dict: A dictionary mapping task names to YOLOV10GUI.core.ultralytics task classes for the RT-DETR model.
        """
        return {
            "detect": {
