...
This module provides an interface to the Segment Anything Model (SAM) from YOLOV10GUI.core.ultralytics, designed for real-time image
...
from YOLOV10GUI.core.ultralytics.utils.torch_utils import model_info
