...
from YOLOV10GUI.core.ultralytics.cfg import TASK2DATA, TASK2METRIC, get_save_dir
from YOLOV10GUI.core.ultralytics.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks
...
def run_ray_tune(
    ...
    LOGGER.info("💡 Learn about RayTune at https://docs.YOLOV10GUI.core.ultralytics.com/integrations/ray-tune")
