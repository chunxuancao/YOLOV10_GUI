...
def spaces_in_path(path):
    ...
    Example:
        ```python
        with YOLOV10GUI.core.ultralytics.utils.files import spaces_in_path
...
def update_models(model_names=("yolov8n.pt",), source_dir=Path(""), update_names=False):
    ...
    Example:
        ```python
        from YOLOV10GUI.core.ultralytics.utils.files import update_models
    ...
    from YOLOV10GUI.core.ultralytics.nn.autobackend import default_class_names
