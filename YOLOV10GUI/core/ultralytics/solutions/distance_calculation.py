...
from YOLOV10GUI.core.ultralytics.utils.checks import check_imshow
from YOLOV10GUI.core.ultralytics.utils.plotting import Annotator, colors
...
class DistanceCalculation:
    ...
    def display_frames(self):
        """Display frame."""
        cv2.namedWindow("YOLOV10GUI.core.ultralytics Distance Estimation")
        cv2.setMouseCallback("YOLOV10GUI.core.ultralytics Distance Estimation", self.mouse_event_for_distance)
        cv2.imshow("YOLOV10GUI.core.ultralytics Distance Estimation", self.im0)
