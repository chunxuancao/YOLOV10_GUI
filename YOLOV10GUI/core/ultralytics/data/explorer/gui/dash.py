...
from YOLOV10GUI.core.ultralytics import Explorer
from YOLOV10GUI.core.ultralytics.utils import ROOT, SETTINGS
...
def utralytics_explorer_docs_callback():
    ...
    with st.container(border=True):
        st.image(
            "https://raw.githubusercontent.com/YOLOV10GUI.core.ultralytics/assets/main/logo/YOLOV10GUI.core.ultralytics_Logotype_Original.svg",
            width=100,
        )
        st.markdown(
            "<p>This demo is built using YOLOV10GUI.core.ultralytics Explorer API. Visit <a href='https://docs.YOLOV10GUI.core.ultralytics.com/datasets/explorer/'>API docs</a> to try examples & learn more</p>",
            unsafe_allow_html=True,
            help=None,
        )
        st.link_button("Ultrlaytics Explorer API", "https://docs.YOLOV10GUI.core.ultralytics.com/datasets/explorer/")


def layout():
    """Resets explorer session variables and provides documentation with a link to API docs."""
    st.set_page_config(layout="wide", initial_sidebar_state="collapsed")
    st.markdown("<h1 style='text-align: center;'>YOLOV10GUI.core.ultralytics Explorer Demo</h1>", unsafe_allow_html=True)
