...
from YOLOV10GUI.core.ultralytics.cfg import TASK2DATA, get_cfg, get_save_dir
from YOLOV10GUI.core.ultralytics.hub.utils import HUB_WEB_ROOT
from YOLOV10GUI.core.ultralytics.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from YOLOV10GUI.core.ultralytics.utils import ASSETS, DEFAULT_CFG_DICT, LOGGER, RANK, SETTINGS, callbacks, checks, emojis, yaml_load
...
class Model(nn.Module):
    ...
    loaded from local files, YOLOV10GUI.core.ultralytics HUB, or Triton Server. The class is designed to be flexible and
    ...
    Args:
        model (Union[str, Path], optional): Path or name of the model to load or create. This can be a local file
            path, a model name from YOLOV10GUI.core.ultralytics HUB, or a Triton Server model. Defaults to 'yolov8n.pt'.
    ...
    Attributes:
        ...
        session (HUBTrainingSession): The YOLOV10GUI.core.ultralytics HUB session, if applicable.
    ...
    Methods:
        ...
        _get_hub_session: Retrieves or creates an YOLOV10GUI.core.ultralytics HUB session.
        is_triton_model: Checks if a model is a Triton Server model.
        is_hub_model: Checks if a model is an YOLOV10GUI.core.ultralytics HUB model.
    ...
    def __init__(
        ...
        sources, including local files, YOLOV10GUI.core.ultralytics HUB models, and Triton Server models. The method initializes several
        important attributes of the model and prepares it for operations like training, prediction, or export.

        Args:
            model (Union[str, Path], optional): The path or model file to load or create. This can be a local
                file path, a model name from YOLOV10GUI.core.ultralytics HUB, or a Triton Server model. Defaults to 'yolov8n.pt'.
        ...
        # Check if YOLOV10GUI.core.ultralytics HUB model from https://hub.YOLOV10GUI.core.ultralytics.com
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[YOLOV10GUI.core.ultralytics.engine.results.Results]): A list of prediction results, encapsulated in the Results class.
        """
    ...
    def _get_hub_session(model: str):
        ...
        from YOLOV10GUI.core.ultralytics.hub.session import HUBTrainingSession
    ...
    def is_hub_model(model: str) -> bool:
        ...
        return any(
            (
                model.startswith(f"{HUB_WEB_ROOT}/models/"),  # i.e. https://hub.YOLOV10GUI.core.ultralytics.com/models/MODEL_ID
    ...
    def reset_weights(self) -> "Model":
        ...
        Returns:
            self (YOLOV10GUI.core.ultralytics.engine.model.Model): The instance of the class with reset weights.
    ...
    def load(self, weights: Union[str, Path] = "yolov8n.pt") -> "Model":
        ...
        Returns:
            self (YOLOV10GUI.core.ultralytics.engine.model.Model): The instance of the class with loaded weights.
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        """
        self._check_is_pytorch_model()
        from YOLOV10GUI.core.ultralytics import __version__
        from datetime import datetime

        updates = {
            "date": datetime.now().isoformat(),
            "version": __version__,
            "license": "AGPL-3.0 License (https://YOLOV10GUI.core.ultralytics.com/license)",
            "docs": "https://docs.YOLOV10GUI.core.ultralytics.com",
        }
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (sys.argv[0].endswith("yolo") or sys.argv[0].endswith("YOLOV10GUI.core.ultralytics")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[YOLOV10GUI.core.ultralytics.engine.results.Results]): A list of tracking results, encapsulated in the Results class.

        Raises:
            AttributeError: If the predictor does not have registered trackers.
        """
        if not hasattr(self.predictor, "trackers"):
            from YOLOV10GUI.core.ultralytics.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the YOLOV10GUI.core.ultralytics.utils.benchmarks module. The benchmarking is configured
        ...
        """
        self._check_is_pytorch_model()
        from YOLOV10GUI.core.ultralytics.utils.benchmarks import benchmark
    ...
    def train(
        ...
        **kwargs,
        ...
        different scenarios, such as resuming training from a checkpoint, integrating with YOLOV10GUI.core.ultralytics HUB, and
        updating model and configuration after training.

        When using YOLOV10GUI.core.ultralytics HUB, if the session already has a loaded model, the method prioritizes HUB training
        ...
        """
        self._check_is_pytorch_model()
        if hasattr(self.session, "model") and self.session.model.id:  # YOLOV10GUI.core.ultralytics HUB session with loaded model
            if any(kwargs):
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the YOLOV10GUI.core.ultralytics.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from YOLOV10GUI.core.ultralytics.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the YOLOV10GUI.core.ultralytics.nn.autobackend module.

        Returns:
            (list | None): The class names of the model if available, otherwise None.
        """
        from YOLOV10GUI.core.ultralytics.nn.autobackend import check_class_names
